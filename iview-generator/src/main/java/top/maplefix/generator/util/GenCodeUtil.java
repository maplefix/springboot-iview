package top.maplefix.generator.util;

import org.apache.commons.lang.StringUtils;
import top.maplefix.generator.entity.ColumnModel;
import top.maplefix.generator.entity.TableModel;
...
public class GenCodeUtil {
     ...
     * 生成Mapper
     */
    private static String genMapper(String author, String packagePath, String beanName) {
        StringBuffer sb = new StringBuffer();
        if (StringUtils.isNotEmpty(packagePath)) {
            sb.append("package " + packagePath + ";\n\n");
        }
        ...
        sb.append("/**\n *@author " + author + "\n **/\n");
        sb.append("public interface " + beanName + "Mapper extends Mapper<" + beanName + "> {\r\n");
        sb.append("\n");
        sb.append("\t/**\n");
    ...
    private static String genService(String author, String packagePath, String beanName, TableModel table) {
        ...
        sb.append("\t\ttry {\n");
        sb.append("\t\t\t" + toFirstCharLowerCase(beanName) + "Mapper.insert(" + toFirstCharLowerCase(beanName) + ");\n");
        ...
        sb.append("\t\ttry {\n");
        sb.append("\t\t\tif(" + toFirstCharLowerCase(beanName) + "Mapper.deleteByPrimaryKey(" + JdbcUtil.getPrimaryKeyName(table) + ")>0){\n");
        ...
        sb.append("\t\ttry {\n");
        sb.append("\t\t\t" + beanName + " " + toFirstCharLowerCase(beanName) + " = " + toFirstCharLowerCase(beanName) + "Mapper.selectByPrimaryKey(" + JdbcUtil.getPrimaryKeyName(table) + ");\n");
        ...
        sb.append("\t\t HashMap<String, Object> res = PageUtil.getResult(" + toFirstCharLowerCase(beanName) + "Mapper.query" + beanName + "List(search));\n");
        ...
        sb.append("\t\tif(" + toFirstCharLowerCase(beanName) + "Mapper.updateByPrimaryKey(" + toFirstCharLowerCase(beanName) + ")>0){\n");
    ...
    public static void genFiles(String author, String tableName,
        ...
        fos.write(MyBatisUtil.genMapperConfig(table, basePackage + ".mapper." + beanName + "Mapper", basePackage + ".entity." + beanName, beanName).getBytes());
        fos.close();
        //生成Mapper
        String mapperPath = createFloder("src/main/java", packagePath + "/mapper");
        File fMapper = new File(mapperPath + "/" + beanName + "Mapper.java");
        fos = new FileOutputStream(fMapper);
        fos.write(genMapper(author, basePackage + ".mapper", beanName).getBytes());
        fos.close();
        //生成Service
    ...
    public static void main(String[] args) throws IOException {
        //genAuthSql("E:\\\\uploadFiles\\\\iview-web", "Test", "system-manage");
        // genRouter("E:\\uploadFiles\\iview-web", "TTest", "abc");
        /*genWebFiles("Maple",
                "t_test",
                "E:\\uploadFiles\\springboot-iview",
                "Test",
                "com.mysql.jdbc.Driver",
                "root",
                "123456",
                "jdbc:mysql://127.0.0.1:3306/boot-iview?characterEncoding=utf-8&useSSL=false&serverTimezone=Asia/Shanghai",
                "sys","E:\\uploadFiles\\springboot-iview\\");*/
        genFiles("Maple",
                "t_test",
                "top.maplefix.generator",
